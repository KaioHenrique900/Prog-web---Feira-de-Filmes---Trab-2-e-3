				...
				<?php
					if (isset($_POST['btnBuscar'])){
						...
						if($_POST['cinema'] != ""){
							...
							$result = mysqli_query($connect, "SELECT nome, endereco, numSalas, capacidadeSala from cinema where LOWER(nome)='$nome'");
							if (mysqli_num_rows($result) > 0){ 
								...
								$erros[] = "<li>Nenhum cinema com esse nome foi encontrado</li>";
							}
							...
							$erros[] = "<li>Campo Buscar Cinema deve ser preenchido</li>";
						}
					...
					if (isset($_POST['btnBuscarAll'])){
						...
						$result = mysqli_query($connect, "SELECT nome, endereco, numSalas, capacidadeSala from cinema");
							if (mysqli_num_rows($result) > 0){ 
